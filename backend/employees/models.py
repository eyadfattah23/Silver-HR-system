...
class Employee(AbstractUser):
    ...
    phone_number2 = models.CharField(
        max_length=20, blank=True, null=True, verbose_name="Secondary Phone Number")
    ...
    identity_number = models.CharField(
        ("Government ID, Passport, etc..."), max_length=20, unique=True)
    # Additional fields
    ...
    REQUIRED_FIELDS = ['first_name', 'rest_of_name', 'date_joined',
